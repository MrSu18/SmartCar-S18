            ...
            switch(KeyGet())
            {
                ...
                case KEY_RIGHT://修改基础速度
                {
                    ...
                    while(1)
                    {
                        ...
                        tft180_show_string(0, 20, "LEFT:base_speed+1");
                        tft180_show_string(0, 30, "RIGHT:base_speed-1");
                        tft180_show_string(0, 40, "DOWN:exit");
                        switch(KeyGet())
                        {
...
* @author: L
************************************************/
uint8 per_image_flag = 0,gray_image_flag = 0;//是否显示灰度或逆透视后的图像，1为显示
