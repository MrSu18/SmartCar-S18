...
uint8 process_status[PROCESS_LENGTH]={4,6,5,'S',3,3,3,3,5,2,1,3,4,6,5,3,3,3,7,'S'};//总状态机元素执行顺序数组
uint16 process_speed[PROCESS_LENGTH]={60,60,60,64,64,64,64,64,64,64,64,64,64,64,64,64,64,64};//上面数组对应的元素路段的速度
