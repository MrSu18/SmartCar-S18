...
//        {
//            if (-1.5<=l_angle_1[j] && l_angle_1[j]<=-1)
//            {
//                //printf("l_angle_1[%d]=%f\n",j,l_angle_1[j]);
//                LCDDrawPoint(f_left_line1[j].Y,f_left_line1[j].X,0,255,0);
//            }
//            if (-1.8<=l_angle_1[j] && l_angle_1[j]<=-1.5)
//            {
//                printf("l_angle_1[%d]=%f\n",j,l_angle_1[j]);
//                LCDDrawPoint(f_left_line1[j].Y,f_left_line1[j].X,255,0,0);
//            }
//        }
//
//        for (int j = 0; j < r_count; ++j)
//        {
//            if (1.5>=r_angle_1[j] && r_angle_1[j]>=1)
//            {
//                //printf("l_angle_1[%d]=%f\n",j,l_angle_1[j]);
//                LCDDrawPoint(f_right_line1[j].Y,f_right_line1[j].X,0,255,0);
//            }
//            if (1.8>=r_angle_1[j] && r_angle_1[j]>=1.5)
//            {
//                printf("l_angle_1[%d]=%f\n",j,l_angle_1[j]);
//                LCDDrawPoint(f_right_line1[j].Y,f_right_line1[j].X,255,0,0);
//            }
//        }
